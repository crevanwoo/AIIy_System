...
(function () {
	...
	(function () { //slider_arrow
		...
		if (nav_arrow[0] && nav_arrow[0].classList.contains('slider_arr')) {
		...
		function sliderMove(e) {
			...
			if (e.target.classList.contains('arrow_left') && index > 0) {
				...
				if (index == 0) {document.querySelector('.slider_phone .arrow_left').setAttribute('hidden', '')}
				if (index < 2 ) {document.querySelector('.slider_phone .arrow_right').removeAttribute('hidden')
				...
				slides_block.style.transform = "translate(-" + size + "%,0)";
				index++
				if (index == 2) {document.querySelector('.slider_phone .arrow_right').setAttribute('hidden', '')}
				if (index > 0) {document.querySelector('.slider_phone .arrow_left').removeAttribute('hidden')
